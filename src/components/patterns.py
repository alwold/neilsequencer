...
class PatternToolBar(Gtk.HBox):
    ...
    def __init__(self, pattern_view):
        ...
        self.pack_start(self.pluginselect, expand=False, fill=True, padding=0)
        self.pack_start(self.patternselect, expand=False, fill=True, padding=0)
        self.pack_start(self.waveselect, expand=False, fill=True, padding=0)
        self.pack_start(Gtk.VSeparator(), expand=False, fill=True, padding=0)
        self.pack_start(self.octavelabel, expand=False, fill=True, padding=0)
        self.pack_start(self.octaveselect, expand=False, fill=True, padding=0)
        self.pack_start(self.edit_step_label, expand=False, fill=True, padding=0)
        self.pack_start(self.edit_step_box, expand=False, fill=True, padding=0)
        self.pack_start(self.playnotes, expand=False, fill=True, padding=0)
        self.pack_start(Gtk.VSeparator(), expand=False, fill=True, padding=0)
        self.pack_start(self.btnhelp, expand=False, fill=True, padding=0)
...
class PatternPanel(Gtk.VBox):
    ...
    def __init__(self):
        ...
        self.statusbar.pack_start(Gtk.VSeparator(), False, True, 0)
