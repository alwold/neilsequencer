...
class SearchPluginsDialog(Gtk.Window):
    ...
    def __init__(self):
        ...
        self.show_generators_button.set_active(
            cfg.pluginlistbrowser_show_generators)
        self.show_effects_button.set_active(cfg.pluginlistbrowser_show_effects)
        self.show_controllers_button.set_active(
            cfg.pluginlistbrowser_show_controllers)
